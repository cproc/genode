...
void JSPropertyNodeListConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSPropertyNodeListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
void JSPropertyNodeList::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSPropertyNodeListPrototype::create(exec->globalData(), globalObject, JSPropertyNodeListPrototype::createStructure(exec->globalData(), globalObject, JSNodeListPrototype::self(exec, globalObject)));
}
...
{
    return wrap<JSPropertyNodeList>(exec, globalObject, impl);
}
