...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBTransactionConstructorTable);
}
...
static const HashTableValue JSIDBTransactionPrototypeTableValues[] =
{
    ...
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBTransactionPrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBTransactionPrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBTransactionPrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBTransactionTable);
}
