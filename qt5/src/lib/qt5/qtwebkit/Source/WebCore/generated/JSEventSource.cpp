...
static const HashTable JSEventSourceTable = { 17, 15, JSEventSourceTableValues, 0 };
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSEventSourceConstructorTable);
}
...
EncodedJSValue JSC_HOST_CALL JSEventSourceConstructor::constructJSEventSource(ExecState* exec)
{
    ...
    ExceptionCode ec = 0;
    const String& scriptUrl(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec));
    ...
    RefPtr<EventSource> object = EventSource::create(context, scriptUrl, ec);
    if (ec) {
...
static const HashTableValue JSEventSourcePrototypeTableValues[] =
{
    ...
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEventSourcePrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEventSourcePrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
void JSEventSource::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSEventSourcePrototype::create(exec->globalData(), globalObject, JSEventSourcePrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
