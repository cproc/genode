...
protected:
    ...
    static const unsigned StructureFlags = JSC::OverridesGetPropertyNames | JSC::ImplementsHasInstance | JSC::OverridesGetOwnPropertySlot | JSC::InterceptsGetOwnPropertySlotByIndexEvenWhenLengthIsNotZero | JSC::OverridesVisitChildren | Base::StructureFlags;
};
...
#endif
#if ENABLE(PROXIMITY_EVENTS)
JSC::JSValue jsDOMWindowDeviceProximityEventConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowDeviceProximityEventConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
