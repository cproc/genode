...
void JSSVGFontFaceUriElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGFontFaceUriElementPrototype::create(exec->globalData(), globalObject, JSSVGFontFaceUriElementPrototype::createStructure(exec->globalData(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
