...
static const HashTableValue JSEntryArraySyncTableValues[] =
{
    ...
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsEntryArraySyncConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSEntryArraySyncTable = { 5, 3, JSEntryArraySyncTableValues, 0 };
/* Hash table for constructor */

static const HashTableValue JSEntryArraySyncConstructorTableValues[] =
{
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSEntryArraySyncConstructorTable = { 1, 0, JSEntryArraySyncConstructorTableValues, 0 };
static const HashTable* getJSEntryArraySyncConstructorTable(ExecState* exec)
{
    return getHashTableForGlobalData(exec->globalData(), &JSEntryArraySyncConstructorTable);
}

const ClassInfo JSEntryArraySyncConstructor::s_info = { "EntryArraySyncConstructor", &Base::s_info, 0, getJSEntryArraySyncConstructorTable, CREATE_METHOD_TABLE(JSEntryArraySyncConstructor) };

JSEntryArraySyncConstructor::JSEntryArraySyncConstructor(Structure* structure, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(structure, globalObject)
{
}

void JSEntryArraySyncConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
bool JSEntryArraySyncConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSEntryArraySyncConstructor, JSDOMWrapper>(exec, getJSEntryArraySyncConstructorTable(exec), jsCast<JSEntryArraySyncConstructor*>(cell), propertyName, slot);
}

bool JSEntryArraySyncConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSEntryArraySyncConstructor, JSDOMWrapper>(exec, getJSEntryArraySyncConstructorTable(exec), jsCast<JSEntryArraySyncConstructor*>(object), propertyName, descriptor);
}
...
void JSEntryArraySync::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSEntryArraySyncPrototype::create(exec->globalData(), globalObject, JSEntryArraySyncPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsEntryArraySyncConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSEntryArraySync* domObject = jsCast<JSEntryArraySync*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSEntryArraySyncConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
