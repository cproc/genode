...
static const HashTableValue JSEntryTableValues[] =
{
    ...
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsEntryConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSEntryTable = { 17, 15, JSEntryTableValues, 0 };
/* Hash table for constructor */

static const HashTableValue JSEntryConstructorTableValues[] =
{
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSEntryConstructorTable = { 1, 0, JSEntryConstructorTableValues, 0 };
static const HashTable* getJSEntryConstructorTable(ExecState* exec)
{
    return getHashTableForGlobalData(exec->globalData(), &JSEntryConstructorTable);
}

const ClassInfo JSEntryConstructor::s_info = { "EntryConstructor", &Base::s_info, 0, getJSEntryConstructorTable, CREATE_METHOD_TABLE(JSEntryConstructor) };

JSEntryConstructor::JSEntryConstructor(Structure* structure, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(structure, globalObject)
{
}

void JSEntryConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
bool JSEntryConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSEntryConstructor, JSDOMWrapper>(exec, getJSEntryConstructorTable(exec), jsCast<JSEntryConstructor*>(cell), propertyName, slot);
}

bool JSEntryConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSEntryConstructor, JSDOMWrapper>(exec, getJSEntryConstructorTable(exec), jsCast<JSEntryConstructor*>(object), propertyName, descriptor);
}
...
{
    { "getMetadata", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEntryPrototypeFunctionGetMetadata), (intptr_t)2, NoIntrinsic },
    { "moveTo", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEntryPrototypeFunctionMoveTo), (intptr_t)4, NoIntrinsic },
    { "copyTo", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEntryPrototypeFunctionCopyTo), (intptr_t)4, NoIntrinsic },
    { "toURL", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEntryPrototypeFunctionToURL), (intptr_t)0, NoIntrinsic },
    { "remove", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEntryPrototypeFunctionRemove), (intptr_t)2, NoIntrinsic },
    { "getParent", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsEntryPrototypeFunctionGetParent), (intptr_t)2, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
void JSEntry::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSEntryPrototype::create(exec->globalData(), globalObject, JSEntryPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsEntryConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSEntry* domObject = jsCast<JSEntry*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSEntryConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
...
EncodedJSValue JSC_HOST_CALL jsEntryPrototypeFunctionMoveTo(ExecState* exec)
{
    ...
    if (exec->argumentCount() < 1)
        return throwVMError(exec, createNotEnoughArgumentsError(exec));
    DirectoryEntry* parent(toDirectoryEntry(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
    ...
    const String& name(valueToStringWithUndefinedOrNullCheck(exec, MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
