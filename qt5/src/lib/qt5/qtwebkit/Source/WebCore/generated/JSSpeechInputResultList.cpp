...
bool JSSpeechInputResultListConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSpeechInputResultListConstructor, JSDOMWrapper>(exec, &JSSpeechInputResultListConstructorTable, jsCast<JSSpeechInputResultListConstructor*>(cell), propertyName, slot);
}

bool JSSpeechInputResultListConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSpeechInputResultListConstructor, JSDOMWrapper>(exec, &JSSpeechInputResultListConstructorTable, jsCast<JSSpeechInputResultListConstructor*>(object), propertyName, descriptor);
}
...
JSValue jsSpeechInputResultListConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSpeechInputResultList* domObject = jsCast<JSSpeechInputResultList*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSSpeechInputResultListConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
