...
void JSCDATASection::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSCDATASectionPrototype::create(exec->globalData(), globalObject, JSCDATASectionPrototype::createStructure(exec->globalData(), globalObject, JSTextPrototype::self(exec, globalObject)));
}
