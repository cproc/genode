...
{
    JSHTMLPropertiesCollection* thisObj = jsCast<JSHTMLPropertiesCollection*>(asObject(slotBase));
    return toJS(exec, thisObj->globalObject(), static_cast<HTMLPropertiesCollection*>(thisObj->impl())->namedItem(propertyNameToAtomicString(propertyName)));
}

JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, HTMLPropertiesCollection* impl)
{
    return wrap<JSHTMLPropertiesCollection>(exec, globalObject, impl);
}
