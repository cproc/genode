...
static const HashTable JSSVGElementInstanceTable = { 137, 127, JSSVGElementInstanceTableValues, 0 };
...
void JSSVGElementInstance::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGElementInstancePrototype::create(exec->globalData(), globalObject, JSSVGElementInstancePrototype::createStructure(exec->globalData(), globalObject, JSEventTargetPrototype::self(exec, globalObject)));
}
