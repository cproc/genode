...
{
    { "toDataURL", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsHTMLCanvasElementPrototypeFunctionToDataURL), (intptr_t)1, NoIntrinsic },
    { "getContext", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsHTMLCanvasElementPrototypeFunctionGetContext), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSHTMLCanvasElementPrototypeTable = { 4, 3, JSHTMLCanvasElementPrototypeTableValues, 0 };
...
void JSHTMLCanvasElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSHTMLCanvasElementPrototype::create(exec->globalData(), globalObject, JSHTMLCanvasElementPrototype::createStructure(exec->globalData(), globalObject, JSHTMLElementPrototype::self(exec, globalObject)));
}
