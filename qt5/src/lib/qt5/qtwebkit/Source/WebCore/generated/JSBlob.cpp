...
{
    return getHashTableForGlobalData(exec->globalData(), &JSBlobConstructorTable);
}
...
{
    { "slice", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsBlobPrototypeFunctionSlice), (intptr_t)3, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
