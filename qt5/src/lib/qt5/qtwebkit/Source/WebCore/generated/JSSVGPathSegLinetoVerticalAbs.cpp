...
{
    { "y", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsSVGPathSegLinetoVerticalAbsY), (intptr_t)setJSSVGPathSegLinetoVerticalAbsY, NoIntrinsic },
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsSVGPathSegLinetoVerticalAbsConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
void JSSVGPathSegLinetoVerticalAbsConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
bool JSSVGPathSegLinetoVerticalAbsConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGPathSegLinetoVerticalAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegLinetoVerticalAbsConstructorTable, jsCast<JSSVGPathSegLinetoVerticalAbsConstructor*>(cell), propertyName, slot);
}

bool JSSVGPathSegLinetoVerticalAbsConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGPathSegLinetoVerticalAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegLinetoVerticalAbsConstructorTable, jsCast<JSSVGPathSegLinetoVerticalAbsConstructor*>(object), propertyName, descriptor);
}
...
void JSSVGPathSegLinetoVerticalAbs::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGPathSegLinetoVerticalAbsPrototype::create(exec->globalData(), globalObject, JSSVGPathSegLinetoVerticalAbsPrototype::createStructure(exec->globalData(), globalObject, JSSVGPathSegPrototype::self(exec, globalObject)));
}

bool JSSVGPathSegLinetoVerticalAbs::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSSVGPathSegLinetoVerticalAbs::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    JSSVGPathSegLinetoVerticalAbs* thisObject = jsCast<JSSVGPathSegLinetoVerticalAbs*>(object);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    return getStaticValueDescriptor<JSSVGPathSegLinetoVerticalAbs, Base>(exec, &JSSVGPathSegLinetoVerticalAbsTable, thisObject, propertyName, descriptor);
}
...
JSValue jsSVGPathSegLinetoVerticalAbsY(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    SVGPathSegLinetoVerticalAbs* impl = static_cast<SVGPathSegLinetoVerticalAbs*>(castedThis->impl());
...
{
    return getDOMConstructor<JSSVGPathSegLinetoVerticalAbsConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
