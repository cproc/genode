...
static const HashTableValue JSDirectoryEntrySyncTableValues[] =
{
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDirectoryEntrySyncConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSDirectoryEntrySyncTable = { 2, 1, JSDirectoryEntrySyncTableValues, 0 };
/* Hash table for constructor */

static const HashTableValue JSDirectoryEntrySyncConstructorTableValues[] =
{
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSDirectoryEntrySyncConstructorTable = { 1, 0, JSDirectoryEntrySyncConstructorTableValues, 0 };
static const HashTable* getJSDirectoryEntrySyncConstructorTable(ExecState* exec)
{
    return getHashTableForGlobalData(exec->globalData(), &JSDirectoryEntrySyncConstructorTable);
}

const ClassInfo JSDirectoryEntrySyncConstructor::s_info = { "DirectoryEntrySyncConstructor", &Base::s_info, 0, getJSDirectoryEntrySyncConstructorTable, CREATE_METHOD_TABLE(JSDirectoryEntrySyncConstructor) };

JSDirectoryEntrySyncConstructor::JSDirectoryEntrySyncConstructor(Structure* structure, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(structure, globalObject)
{
}

void JSDirectoryEntrySyncConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
bool JSDirectoryEntrySyncConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSDirectoryEntrySyncConstructor, JSDOMWrapper>(exec, getJSDirectoryEntrySyncConstructorTable(exec), jsCast<JSDirectoryEntrySyncConstructor*>(cell), propertyName, slot);
}

bool JSDirectoryEntrySyncConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSDirectoryEntrySyncConstructor, JSDOMWrapper>(exec, getJSDirectoryEntrySyncConstructorTable(exec), jsCast<JSDirectoryEntrySyncConstructor*>(object), propertyName, descriptor);
}
...
const ClassInfo JSDirectoryEntrySync::s_info = { "DirectoryEntrySync", &Base::s_info, 0, getJSDirectoryEntrySyncTable , CREATE_METHOD_TABLE(JSDirectoryEntrySync) };
...
void JSDirectoryEntrySync::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSDirectoryEntrySyncPrototype::create(exec->globalData(), globalObject, JSDirectoryEntrySyncPrototype::createStructure(exec->globalData(), globalObject, JSEntrySyncPrototype::self(exec, globalObject)));
}

bool JSDirectoryEntrySync::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    JSDirectoryEntrySync* thisObject = jsCast<JSDirectoryEntrySync*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    return getStaticValueSlot<JSDirectoryEntrySync, Base>(exec, getJSDirectoryEntrySyncTable(exec), thisObject, propertyName, slot);
}

bool JSDirectoryEntrySync::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    JSDirectoryEntrySync* thisObject = jsCast<JSDirectoryEntrySync*>(object);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    return getStaticValueDescriptor<JSDirectoryEntrySync, Base>(exec, getJSDirectoryEntrySyncTable(exec), thisObject, propertyName, descriptor);
}

JSValue jsDirectoryEntrySyncConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSDirectoryEntrySync* domObject = jsCast<JSDirectoryEntrySync*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSDirectoryEntrySyncConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
...
EncodedJSValue JSC_HOST_CALL jsDirectoryEntrySyncPrototypeFunctionGetFile(ExecState* exec)
{
    ...
    Dictionary flags(exec, MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
