...
void JSSVGRadialGradientElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGRadialGradientElementPrototype::create(exec->globalData(), globalObject, JSSVGRadialGradientElementPrototype::createStructure(exec->globalData(), globalObject, JSSVGGradientElementPrototype::self(exec, globalObject)));
}
