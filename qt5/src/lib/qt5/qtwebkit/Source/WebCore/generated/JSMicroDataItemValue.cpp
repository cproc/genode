...
void JSMicroDataItemValue::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSMicroDataItemValuePrototype::create(exec->globalData(), globalObject, JSMicroDataItemValuePrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
