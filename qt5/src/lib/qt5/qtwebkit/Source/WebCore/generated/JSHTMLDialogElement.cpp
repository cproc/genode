...
void JSHTMLDialogElementConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSHTMLDialogElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
void JSHTMLDialogElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSHTMLDialogElementPrototype::create(exec->globalData(), globalObject, JSHTMLDialogElementPrototype::createStructure(exec->globalData(), globalObject, JSHTMLElementPrototype::self(exec, globalObject)));
}
