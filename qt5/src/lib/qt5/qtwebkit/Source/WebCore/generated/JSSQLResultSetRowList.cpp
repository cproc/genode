...
void JSSQLResultSetRowList::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSQLResultSetRowListPrototype::create(exec->globalData(), globalObject, JSSQLResultSetRowListPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
