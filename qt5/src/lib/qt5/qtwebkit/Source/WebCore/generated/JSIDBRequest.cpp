...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBRequestConstructorTable);
}
...
{
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBRequestPrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBRequestPrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBRequestPrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBRequestTable);
}
...
void JSIDBRequest::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSIDBRequestPrototype::create(exec->globalData(), globalObject, JSIDBRequestPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
