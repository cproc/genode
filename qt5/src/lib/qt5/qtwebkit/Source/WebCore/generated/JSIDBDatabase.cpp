...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBDatabaseConstructorTable);
}
...
{
    { "createObjectStore", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBDatabasePrototypeFunctionCreateObjectStore), (intptr_t)2, NoIntrinsic },
    ...
    { "transaction", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBDatabasePrototypeFunctionTransaction), (intptr_t)2, NoIntrinsic },
    ...
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBDatabasePrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBDatabasePrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBDatabasePrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBDatabaseTable);
}
...
EncodedJSValue JSC_HOST_CALL jsIDBDatabasePrototypeFunctionCreateObjectStore(ExecState* exec)
{
    ...
    JSC::JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(impl->createObjectStore(name, options, ec)));
...
static EncodedJSValue JSC_HOST_CALL jsIDBDatabasePrototypeFunctionTransaction1(ExecState* exec)
{
    ...
    if (!scriptContext)
        return JSValue::encode(jsUndefined());
    RefPtr<DOMStringList> storeNames(toDOMStringList(exec, MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& mode(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsNullString).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsNullString).toString(exec)->value(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
static EncodedJSValue JSC_HOST_CALL jsIDBDatabasePrototypeFunctionTransaction2(ExecState* exec)
{
    ...
    if (!scriptContext)
        return JSValue::encode(jsUndefined());
    Vector<String> storeNames(toNativeArray<String>(exec, MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& mode(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsNullString).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsNullString).toString(exec)->value(exec));
    if (exec->hadException())
...
static EncodedJSValue JSC_HOST_CALL jsIDBDatabasePrototypeFunctionTransaction3(ExecState* exec)
{
    ...
    if (!scriptContext)
        return JSValue::encode(jsUndefined());
    const String& storeName(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& mode(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsNullString).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsNullString).toString(exec)->value(exec));
    if (exec->hadException())
