...
{
    { "insertRow", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsHTMLTableSectionElementPrototypeFunctionInsertRow), (intptr_t)1, NoIntrinsic },
    { "deleteRow", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsHTMLTableSectionElementPrototypeFunctionDeleteRow), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
void JSHTMLTableSectionElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSHTMLTableSectionElementPrototype::create(exec->globalData(), globalObject, JSHTMLTableSectionElementPrototype::createStructure(exec->globalData(), globalObject, JSHTMLElementPrototype::self(exec, globalObject)));
}
