...
{
    return getHashTableForGlobalData(exec->globalData(), &JSFileReaderConstructorTable);
}
...
static const HashTableValue JSFileReaderPrototypeTableValues[] =
{
    ...
    { "readAsText", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsFileReaderPrototypeFunctionReadAsText), (intptr_t)2, NoIntrinsic },
    ...
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsFileReaderPrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsFileReaderPrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
void JSFileReader::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSFileReaderPrototype::create(exec->globalData(), globalObject, JSFileReaderPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
EncodedJSValue JSC_HOST_CALL jsFileReaderPrototypeFunctionReadAsText(ExecState* exec)
{
    ...
    const String& encoding(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toString(exec)->value(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
