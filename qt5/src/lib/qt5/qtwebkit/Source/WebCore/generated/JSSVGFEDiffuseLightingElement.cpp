...
bool JSSVGFEDiffuseLightingElementPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSSVGFEDiffuseLightingElementPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsSVGFEDiffuseLightingElementClassName(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEDiffuseLightingElement* castedThis = jsCast<JSSVGFEDiffuseLightingElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEDiffuseLightingElement* impl = static_cast<SVGFEDiffuseLightingElement*>(castedThis->impl());
...
JSValue jsSVGFEDiffuseLightingElementStyle(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEDiffuseLightingElement* castedThis = jsCast<JSSVGFEDiffuseLightingElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEDiffuseLightingElement* impl = static_cast<SVGFEDiffuseLightingElement*>(castedThis->impl());
...
EncodedJSValue JSC_HOST_CALL jsSVGFEDiffuseLightingElementPrototypeFunctionGetPresentationAttribute(ExecState* exec)
{
    ...
    JSSVGFEDiffuseLightingElement* castedThis = jsCast<JSSVGFEDiffuseLightingElement*>(asObject(thisValue));
