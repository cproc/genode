...
{
    return getHashTableForGlobalData(exec->globalData(), &JSMessagePortConstructorTable);
}
...
{
    { "postMessage", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsMessagePortPrototypeFunctionPostMessage), (intptr_t)2, NoIntrinsic },
    { "webkitPostMessage", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsMessagePortPrototypeFunctionWebkitPostMessage), (intptr_t)2, NoIntrinsic },
    ...
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsMessagePortPrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsMessagePortPrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
void JSMessagePort::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSMessagePortPrototype::create(exec->globalData(), globalObject, JSMessagePortPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
EncodedJSValue JSC_HOST_CALL jsMessagePortPrototypeFunctionWebkitPostMessage(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSMessagePort::s_info))
        return throwVMTypeError(exec);
