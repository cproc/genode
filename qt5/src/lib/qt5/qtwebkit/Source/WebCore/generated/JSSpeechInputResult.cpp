...
bool JSSpeechInputResultConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSpeechInputResultConstructor, JSDOMWrapper>(exec, &JSSpeechInputResultConstructorTable, jsCast<JSSpeechInputResultConstructor*>(cell), propertyName, slot);
}

bool JSSpeechInputResultConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSpeechInputResultConstructor, JSDOMWrapper>(exec, &JSSpeechInputResultConstructorTable, jsCast<JSSpeechInputResultConstructor*>(object), propertyName, descriptor);
}
...
JSValue jsSpeechInputResultConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSpeechInputResult* domObject = jsCast<JSSpeechInputResult*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSSpeechInputResultConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
