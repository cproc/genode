...
bool JSSVGFESpecularLightingElementPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSSVGFESpecularLightingElementPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsSVGFESpecularLightingElementClassName(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFESpecularLightingElement* castedThis = jsCast<JSSVGFESpecularLightingElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFESpecularLightingElement* impl = static_cast<SVGFESpecularLightingElement*>(castedThis->impl());
...
JSValue jsSVGFESpecularLightingElementStyle(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFESpecularLightingElement* castedThis = jsCast<JSSVGFESpecularLightingElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFESpecularLightingElement* impl = static_cast<SVGFESpecularLightingElement*>(castedThis->impl());
...
EncodedJSValue JSC_HOST_CALL jsSVGFESpecularLightingElementPrototypeFunctionGetPresentationAttribute(ExecState* exec)
{
    ...
    JSSVGFESpecularLightingElement* castedThis = jsCast<JSSVGFESpecularLightingElement*>(asObject(thisValue));
