...
void JSPerformanceEntryList::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSPerformanceEntryListPrototype::create(exec->globalData(), globalObject, JSPerformanceEntryListPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
{
    return wrap<JSPerformanceEntryList>(exec, globalObject, impl);
}
