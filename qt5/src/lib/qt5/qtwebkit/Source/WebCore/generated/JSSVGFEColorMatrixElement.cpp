...
JSValue jsSVGFEColorMatrixElementClassName(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEColorMatrixElement* castedThis = jsCast<JSSVGFEColorMatrixElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEColorMatrixElement* impl = static_cast<SVGFEColorMatrixElement*>(castedThis->impl());
...
JSValue jsSVGFEColorMatrixElementStyle(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEColorMatrixElement* castedThis = jsCast<JSSVGFEColorMatrixElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEColorMatrixElement* impl = static_cast<SVGFEColorMatrixElement*>(castedThis->impl());
...
EncodedJSValue JSC_HOST_CALL jsSVGFEColorMatrixElementPrototypeFunctionGetPresentationAttribute(ExecState* exec)
{
    ...
    JSSVGFEColorMatrixElement* castedThis = jsCast<JSSVGFEColorMatrixElement*>(asObject(thisValue));
