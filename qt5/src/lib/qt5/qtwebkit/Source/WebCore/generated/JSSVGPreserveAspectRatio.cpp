...
void JSSVGPreserveAspectRatio::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGPreserveAspectRatioPrototype::create(exec->globalData(), globalObject, JSSVGPreserveAspectRatioPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
void setJSSVGPreserveAspectRatioAlign(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    podImpl.setAlign(value.toUInt32(exec), ec);
...
void setJSSVGPreserveAspectRatioMeetOrSlice(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    SVGPreserveAspectRatio& podImpl = impl->propertyReference();
    podImpl.setMeetOrSlice(value.toUInt32(exec), ec);
    setDOMException(exec, ec);
    if (!ec)
        impl->commitChange();
}
