...
static const HashTableValue JSEntrySyncTableValues[] =
{
    ...
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsEntrySyncConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSEntrySyncTable = { 17, 15, JSEntrySyncTableValues, 0 };
/* Hash table for constructor */

static const HashTableValue JSEntrySyncConstructorTableValues[] =
{
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSEntrySyncConstructorTable = { 1, 0, JSEntrySyncConstructorTableValues, 0 };
static const HashTable* getJSEntrySyncConstructorTable(ExecState* exec)
{
    return getHashTableForGlobalData(exec->globalData(), &JSEntrySyncConstructorTable);
}

const ClassInfo JSEntrySyncConstructor::s_info = { "EntrySyncConstructor", &Base::s_info, 0, getJSEntrySyncConstructorTable, CREATE_METHOD_TABLE(JSEntrySyncConstructor) };

JSEntrySyncConstructor::JSEntrySyncConstructor(Structure* structure, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(structure, globalObject)
{
}

void JSEntrySyncConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
...
bool JSEntrySyncConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSEntrySyncConstructor, JSDOMWrapper>(exec, getJSEntrySyncConstructorTable(exec), jsCast<JSEntrySyncConstructor*>(cell), propertyName, slot);
}

bool JSEntrySyncConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, PropertyName propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSEntrySyncConstructor, JSDOMWrapper>(exec, getJSEntrySyncConstructorTable(exec), jsCast<JSEntrySyncConstructor*>(object), propertyName, descriptor);
}
...
void JSEntrySync::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSEntrySyncPrototype::create(exec->globalData(), globalObject, JSEntrySyncPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsEntrySyncConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSEntrySync* domObject = jsCast<JSEntrySync*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSEntrySyncConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
...
EncodedJSValue JSC_HOST_CALL jsEntrySyncPrototypeFunctionMoveTo(ExecState* exec)
{
    ...
    ExceptionCode ec = 0;
    DirectoryEntrySync* parent(toDirectoryEntrySync(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
