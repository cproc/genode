...
JSValue jsHTMLAppletElementHspace(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLAppletElement* impl = static_cast<HTMLAppletElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::hspaceAttr));
    return result;
}
...
JSValue jsHTMLAppletElementObject(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLAppletElement* impl = static_cast<HTMLAppletElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::objectAttr));
    return result;
}
...
JSValue jsHTMLAppletElementVspace(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLAppletElement* impl = static_cast<HTMLAppletElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::vspaceAttr));
    return result;
}
