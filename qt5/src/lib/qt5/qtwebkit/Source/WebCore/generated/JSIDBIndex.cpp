...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBIndexConstructorTable);
}
...
{
    { "openCursor", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBIndexPrototypeFunctionOpenCursor), (intptr_t)2, NoIntrinsic },
    { "openKeyCursor", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBIndexPrototypeFunctionOpenKeyCursor), (intptr_t)2, NoIntrinsic },
    ...
    { "count", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBIndexPrototypeFunctionCount), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBIndexPrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBIndexTable);
}
...
void JSIDBIndex::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSIDBIndexPrototype::create(exec->globalData(), globalObject, JSIDBIndexPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
