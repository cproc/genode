...
static const HashTableValue JSDOMWindowTableValues[] =
{
    ...
    { "WebKitCSSMixFunctionValue", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowWebKitCSSMixFunctionValueConstructor), (intptr_t)setJSDOMWindowWebKitCSSMixFunctionValueConstructor, NoIntrinsic },
...
static const HashTable JSDOMWindowTable = { 2111, 2047, JSDOMWindowTableValues, 0 };
...
void setJSDOMWindowWebKitCSSMixFunctionValueConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, jsCast<JSDOMWindow*>(thisObject)->impl()))
        return;
    // Shadowing a built-in constructor
    jsCast<JSDOMWindow*>(thisObject)->putDirect(exec->globalData(), Identifier(exec, "WebKitCSSMixFunctionValue"), value);
}
