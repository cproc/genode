...
{
    return getHashTableForGlobalData(exec->globalData(), &JSWorkerLocationConstructorTable);
}
...
void JSWorkerLocation::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSWorkerLocationPrototype::create(exec->globalData(), globalObject, JSWorkerLocationPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
