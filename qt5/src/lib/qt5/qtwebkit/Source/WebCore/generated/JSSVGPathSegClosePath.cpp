...
void JSSVGPathSegClosePath::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGPathSegClosePathPrototype::create(exec->globalData(), globalObject, JSSVGPathSegClosePathPrototype::createStructure(exec->globalData(), globalObject, JSSVGPathSegPrototype::self(exec, globalObject)));
}
