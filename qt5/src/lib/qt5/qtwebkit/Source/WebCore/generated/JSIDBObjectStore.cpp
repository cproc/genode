...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBObjectStoreConstructorTable);
}
...
{
    { "put", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBObjectStorePrototypeFunctionPut), (intptr_t)2, NoIntrinsic },
    { "add", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBObjectStorePrototypeFunctionAdd), (intptr_t)2, NoIntrinsic },
    ...
    { "openCursor", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBObjectStorePrototypeFunctionOpenCursor), (intptr_t)2, NoIntrinsic },
    { "createIndex", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBObjectStorePrototypeFunctionCreateIndex), (intptr_t)3, NoIntrinsic },
    ...
    { "count", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsIDBObjectStorePrototypeFunctionCount), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBObjectStorePrototypeTable);
}
...
{
    return getHashTableForGlobalData(exec->globalData(), &JSIDBObjectStoreTable);
}
...
void JSIDBObjectStore::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSIDBObjectStorePrototype::create(exec->globalData(), globalObject, JSIDBObjectStorePrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionPut(ExecState* exec)
{
    ...
    PassRefPtr<IDBKey> key(createIDBKeyFromValue(exec, MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
static EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionDelete1(ExecState* exec)
{
    ...
    if (!scriptContext)
        return JSValue::encode(jsUndefined());
    IDBKeyRange* keyRange(toIDBKeyRange(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
static EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionGet1(ExecState* exec)
{
    ...
    if (!scriptContext)
        return JSValue::encode(jsUndefined());
    IDBKeyRange* key(toIDBKeyRange(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
static EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionOpenCursor1(ExecState* exec)
{
    ...
    IDBKeyRange* range(toIDBKeyRange(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    if (argsCount <= 1) {
...
static EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionCreateIndex1(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSIDBObjectStore::s_info))
        return throwVMTypeError(exec);
    ...
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    Vector<String> keyPath(toNativeArray<String>(exec, MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    Dictionary options(exec, MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());

    JSC::JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(impl->createIndex(scriptContext, name, keyPath, options, ec)));
    setDOMException(exec, ec);
    return JSValue::encode(result);
}

static EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionCreateIndex2(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSIDBObjectStore::s_info))
        return throwVMTypeError(exec);
    ...
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& keyPath(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).isEmpty() ? String() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toString(exec)->value(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    Dictionary options(exec, MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined));
    if (exec->hadException())
...
EncodedJSValue JSC_HOST_CALL jsIDBObjectStorePrototypeFunctionCreateIndex(ExecState* exec)
{
    ...
    if ((argsCount == 2 && (arg1.isObject() && isJSArray(arg1))) || (argsCount == 3 && (arg1.isObject() && isJSArray(arg1))))
        return jsIDBObjectStorePrototypeFunctionCreateIndex1(exec);
    if (argsCount == 2 || argsCount == 3)
        return jsIDBObjectStorePrototypeFunctionCreateIndex2(exec);
    if (argsCount < 2)
        return throwVMError(exec, createNotEnoughArgumentsError(exec));
    return throwVMTypeError(exec);
}
