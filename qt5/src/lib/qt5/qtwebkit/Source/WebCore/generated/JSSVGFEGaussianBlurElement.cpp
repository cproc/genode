...
JSValue jsSVGFEGaussianBlurElementClassName(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEGaussianBlurElement* castedThis = jsCast<JSSVGFEGaussianBlurElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEGaussianBlurElement* impl = static_cast<SVGFEGaussianBlurElement*>(castedThis->impl());
...
JSValue jsSVGFEGaussianBlurElementStyle(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEGaussianBlurElement* castedThis = jsCast<JSSVGFEGaussianBlurElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEGaussianBlurElement* impl = static_cast<SVGFEGaussianBlurElement*>(castedThis->impl());
