...
void JSPerformanceResourceTiming::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSPerformanceResourceTimingPrototype::create(exec->globalData(), globalObject, JSPerformanceResourceTimingPrototype::createStructure(exec->globalData(), globalObject, JSPerformanceEntryPrototype::self(exec, globalObject)));
}
