...
JSValue jsSVGFEConvolveMatrixElementClassName(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEConvolveMatrixElement* castedThis = jsCast<JSSVGFEConvolveMatrixElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEConvolveMatrixElement* impl = static_cast<SVGFEConvolveMatrixElement*>(castedThis->impl());
...
JSValue jsSVGFEConvolveMatrixElementStyle(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSSVGFEConvolveMatrixElement* castedThis = jsCast<JSSVGFEConvolveMatrixElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    SVGFEConvolveMatrixElement* impl = static_cast<SVGFEConvolveMatrixElement*>(castedThis->impl());
...
EncodedJSValue JSC_HOST_CALL jsSVGFEConvolveMatrixElementPrototypeFunctionGetPresentationAttribute(ExecState* exec)
{
    ...
    JSSVGFEConvolveMatrixElement* castedThis = jsCast<JSSVGFEConvolveMatrixElement*>(asObject(thisValue));
