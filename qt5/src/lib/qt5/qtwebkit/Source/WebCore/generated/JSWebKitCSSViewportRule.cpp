...
void JSWebKitCSSViewportRuleConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSWebKitCSSViewportRulePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
void JSWebKitCSSViewportRule::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSWebKitCSSViewportRulePrototype::create(exec->globalData(), globalObject, JSWebKitCSSViewportRulePrototype::createStructure(exec->globalData(), globalObject, JSCSSRulePrototype::self(exec, globalObject)));
}
