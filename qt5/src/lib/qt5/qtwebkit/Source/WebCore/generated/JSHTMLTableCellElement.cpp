...
JSValue jsHTMLTableCellElementAbbr(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLTableCellElement* impl = static_cast<HTMLTableCellElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::abbrAttr));
    return result;
}
...
JSValue jsHTMLTableCellElementAxis(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLTableCellElement* impl = static_cast<HTMLTableCellElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::axisAttr));
    return result;
}
...
JSValue jsHTMLTableCellElementHeaders(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLTableCellElement* impl = static_cast<HTMLTableCellElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::headersAttr));
    return result;
}
...
JSValue jsHTMLTableCellElementScope(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    HTMLTableCellElement* impl = static_cast<HTMLTableCellElement*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->getAttribute(WebCore::HTMLNames::scopeAttr));
    return result;
}
