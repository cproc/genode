...
void JSSVGSetElement::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSSVGSetElementPrototype::create(exec->globalData(), globalObject, JSSVGSetElementPrototype::createStructure(exec->globalData(), globalObject, JSSVGAnimationElementPrototype::self(exec, globalObject)));
}
