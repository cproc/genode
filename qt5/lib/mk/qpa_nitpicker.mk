...
INC_DIR += $(REP_DIR)/contrib/$(QT4)/qtbase/src/platformsupport/eventdispatchers \
           $(REP_DIR)/contrib/$(QT4)/qtbase/src/platformsupport/input/evdevkeyboard \
           ...
           $(REP_DIR)/contrib/$(QT4)/qtbase/include/QtGui/$(QT_VERSION) \
           $(REP_DIR)/contrib/$(QT4)/qtbase/include/QtGui/$(QT_VERSION)/QtGui \
           $(REP_DIR)/contrib/$(QT4)/qtbase/include/QtCore/$(QT_VERSION) \
...
vpath % $(call select_from_repositories,contrib/$(QT4)/qtbase/src/platformsupport/input/evdevkeyboard)
