...
INC_DIR += $(REP_DIR)/include/qt4/qtbase/QtGui/private \
           $(REP_DIR)/contrib/$(QT4)/qtbase/include/QtGui/private

#LIBS += qt_core qpa_nitpicker libpng zlib libc libm freetype jpeg
LIBS += qt_core libpng zlib libc libm freetype jpeg

vpath % $(REP_DIR)/include/qt4/qtbase/QtGui
vpath % $(REP_DIR)/include/qt4/qtbase/QtGui/private
