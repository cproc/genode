...
util/u_format_srgb.c: $(REP_DIR)/contrib/$(MESA_DIR)/src/gallium/auxiliary/util/u_format_srgb.py
	$(MSG_CONVERT)$@
	$(PYTHON2) $< > $@

util/u_format_table.c: $(REP_DIR)/contrib/$(MESA_DIR)/src/gallium/auxiliary/util/u_format_table.py
	$(MSG_CONVERT)$@
	$(PYTHON2) $< $(REP_DIR)/contrib/$(MESA_DIR)/src/gallium/auxiliary/util/u_format.csv > $@
