...
Genode::log("Dir_file_system::open_composite_dirs() r: ", (int)r);
						return r;
					default:
						continue;
					}
...
Genode::error("Dir_file_system::open_composite_dirs(): OUT_OF_RAM");
//wait_for_continue();
				res = OPENDIR_ERR_OUT_OF_RAM;
			}
			catch (Genode::Out_of_caps) {
Genode::error("Dir_file_system::open_composite_dirs(): OUT_OF_CAPS");
//wait_for_continue();
				res = OPENDIR_ERR_OUT_OF_CAPS;
			}
