                      ...
                      Drivers::Action
{
	...
	Board_info::Soc _soc {
		.fb    = _mnt_reform || _mnt_pocket || _armstone || _imx8q_evk,
		.touch = false,
		.wifi  = _mnt_pocket, /* initialized via PCI on Reform */
		.usb   = _mnt_reform || _mnt_pocket || _armstone || _imx8q_evk,
		.mmc   = _mnt_reform || _mnt_pocket || _armstone,
		.modem = false,
		.nic   = _mnt_reform || _mnt_pocket || _armstone || _imx8q_evk,
	...
	Board_info::Options _driver_options {
		.display = _mnt_reform || _mnt_pocket || _armstone || _imx8q_evk,
		.usb_net = false,
		.nic     = false,
		.wifi    = _mnt_pocket,
		.suppress {},
