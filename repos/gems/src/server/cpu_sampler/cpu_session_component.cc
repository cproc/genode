...
void Cpu_sampler::Cpu_session_component::exception_sigh(Signal_context_capability handler)
{
...
int Cpu_sampler::Cpu_session_component::transfer_quota(Cpu_session_capability cap, size_t size)
{
	Genode::warning(__PRETTY_FUNCTION__, ": not implemented");
	return -1;
}
...
Cpu_session::Quota
Cpu_sampler::Cpu_session_component::quota()
{
	Genode::warning(__PRETTY_FUNCTION__, ": not implemented");
	return Quota();
}
