...
class Sampling_cpu_service::Native_cpu_component : public Rpc_object<Nova_native_cpu,
...
Sampling_cpu_service::Cpu_session_component::_setup_native_cpu()
{
...
void Sampling_cpu_service::Cpu_session_component::_cleanup_native_cpu()
{
