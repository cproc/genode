 ...
 */
struct Vfs_oss::Context_factory : File_system_factory
{
	Vfs::Env &_env;
	...
	Io::Watch_handler<Context_factory> _enable_input_handler {
		_enable_input_fs, "/enable_input",
		_env.alloc(),
		*this,
		&Context_factory::_enable_input_changed };

	Io::Watch_handler<Context_factory> _halt_input_handler {
		_halt_input_fs, "/halt_input",
		_env.alloc(),
		*this,
		&Context_factory::_halt_input_changed };

	Io::Watch_handler<Context_factory> _ifrag_total_handler {
		_ifrag_total_fs, "/ifrag_total",
		_env.alloc(),
		*this,
		&Context_factory::_ifrag_total_changed };

	Io::Watch_handler<Context_factory> _ifrag_size_handler {
		_ifrag_size_fs, "/ifrag_size",
		_env.alloc(),
		*this,
		&Context_factory::_ifrag_size_changed };

	Io::Watch_handler<Context_factory> _enable_output_handler {
		_enable_output_fs, "/enable_output",
		_env.alloc(),
		*this,
		&Context_factory::_enable_output_changed };

	Io::Watch_handler<Context_factory> _halt_output_handler {
		_halt_output_fs, "/halt_output",
		_env.alloc(),
		*this,
		&Context_factory::_halt_output_changed };

	Io::Watch_handler<Context_factory> _ofrag_total_handler {
		_ofrag_total_fs, "/ofrag_total",
		_env.alloc(),
		*this,
		&Context_factory::_ofrag_total_changed };

	Io::Watch_handler<Context_factory> _ofrag_size_handler {
		_ofrag_size_fs, "/ofrag_size",
		_env.alloc(),
		*this,
		&Context_factory::_ofrag_size_changed };

	Io::Watch_handler<Context_factory> _play_underruns_handler {
		_play_underruns_fs, "/play_underruns",
		_env.alloc(),
		*this,
		&Context_factory::_play_underruns_changed };

	Io::Watch_handler<Context_factory> _sample_rate_handler {
		_sample_rate_fs, "/sample_rate",
		_env.alloc(),
		*this,
		&Context_factory::_sample_rate_changed };
...
class Vfs_oss::Context_file_system : private Id_space<Context_file_system>::Element,
 ...
 */
class Vfs_oss::Contexts_file_system : public Vfs::File_system
{
	private:
...
Vfs_oss::Context_file_system::Context_file_system(Vfs::Env &vfs_env,
	...
	private:
		...
		class Oss_vfs_handle : public Single_vfs_handle
		{
			private:
				...
				Io_signal_handler<Data_file_system::Oss_vfs_handle> _play_timer {
					_ep, *this, &Data_file_system::Oss_vfs_handle::_handle_play_timer };
				...
				Io_signal_handler<Data_file_system::Oss_vfs_handle> _record_timer {
					_ep, *this, &Data_file_system::Oss_vfs_handle::_handle_record_timer };
...
class Vfs_oss::File_system : private Local_factory,
                             public  Vfs::Dir_file_system
{
	...
	public:
		...
		File_system(Vfs::Env &vfs_env, Genode::Node const &config)
		:
...
extern "C" Genode::Vfs::File_system_factory *vfs_file_system_factory(void)
{
	...
	struct Factory : Vfs::File_system_factory
	{
		...
		{
			static Buffered_node buffered_config(env.alloc(), config);
			return new (env.alloc())
				Vfs_oss::File_system(env, buffered_config);
