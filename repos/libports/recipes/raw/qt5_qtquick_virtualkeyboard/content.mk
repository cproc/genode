...
$(QMLDIR): $(INSTALL_DIR)
	$(VERBOSE)cp $(PORT_DIR)/src/lib/qt5/qt5/qtvirtualkeyboard/src/virtualkeyboard/import/qmldir $@

$(STYLES_QMLDIR): $(INSTALL_DIR)/Styles
	$(VERBOSE)cp $(PORT_DIR)/src/lib/qt5/qt5/qtvirtualkeyboard/src/virtualkeyboard/styles/qmldir $@
