...
$(addprefix samegame/, $(SAMEGAME3_RESOURCES)): samegame
	$(VERBOSE)cp $(PORT_DIR)/src/lib/qt5/qt-everywhere-opensource-src-5.8.0/qtdeclarative/examples/quick/tutorials/samegame/samegame3/$(notdir $@) $@

$(addprefix samegame/shared/pics/, $(SAMEGAME_RESOURCES)): samegame/shared/pics
	$(VERBOSE)cp $(PORT_DIR)/src/lib/qt5/qt-everywhere-opensource-src-5.8.0/qtdeclarative/examples/quick/tutorials/samegame/shared/pics/$(notdir $@) $@
