...
built.tag: qmake_prepared.tag
	...
	cd $(CURDIR)/install/qt/qml/QtWebEngine && \
	...
	ln -sf $(CURDIR)/install/qt/qml/QtWebEngine/libqtwebengineplugin.lib.so.stripped $(PWD)/bin/libqtwebengineplugin.lib.so
	...
	ln -sf $(CURDIR)/install/qt/qml/QtWebEngine/libqtwebengineplugin.lib.so $(PWD)/debug/
	...
	tar chf $(PWD)/bin/qt5_webengine_qml.tar --exclude='*.lib.so' --transform='s/\.stripped//' -C install qt/qml
