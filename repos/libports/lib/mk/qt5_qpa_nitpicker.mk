...
vpath qevdevkeyboardhandler_p.h    $(call select_from_repositories,include/QtInputSupport/$(QT_VERSION)/QtInputSupport/private)
...
LIBS += qt5_gui qt5_core qoost mesa freetype libc

$(info xxx: INC_DIR: $(INC_DIR))
$(info xxx: $(QT5_CONTRIB_DIR)/qtbase/src/platformsupport/eventdispatchers)
