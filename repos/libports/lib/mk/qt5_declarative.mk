...
built.tag: qmake_prepared.tag
	...
	tar chf $(PWD)/bin/qt5_qtquick_layouts.tar -C install --exclude '*.lib.so' qt/qml/QtQuick/Layouts
	tar chf $(PWD)/bin/qt5_qquicklayoutsplugin.tar -C install qt/qml/QtQuick/Layouts/libqquicklayoutsplugin.lib.so
