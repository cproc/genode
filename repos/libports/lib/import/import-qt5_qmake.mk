...
#
# QT5_LIBS:           Qt5 libraries used (for example libQt5Core)
...
qmake_root:
	...
	ln -s $(QT_TOOLS_DIR)/bin qmake_root/

	ln -s $(QT_API_DIR)/include qmake_root/
	...
	# add symlinks for Qt5 libraries listed in the 'QT5_LIBS' variable
ifeq ($(CONTRIB_DIR),)
	for qt5_lib in $(QT5_LIBS); do \
