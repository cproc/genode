...
ifeq ($(CONTRIB_DIR),)
QT5_GUI_INC_DIR := $(call select_from_repositories,include/QtGui)
else
QT5_GUI_INC_DIR := $(QT5_PORT_DIR)/include/QtGui
endif

QT5_INC_DIR += $(QT5_GUI_INC_DIR)
QT5_INC_DIR += $(QT5_GUI_INC_DIR)/$(QT_VERSION)
QT5_INC_DIR += $(QT5_GUI_INC_DIR)/$(QT_VERSION)/QtGui
