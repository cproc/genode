...
class Im_enabled_item : public QQuickItem
{
	...
	protected:
		...
		QVariant inputMethodQuery(Qt::InputMethodQuery query) const override
		{
			...
			QVariant r = QQuickItem::inputMethodQuery(query);
			if (query == Qt::ImHints) {
				qDebug() << "r: " << r;
...
int main(int argc, char *argv[])
{
	...
	/* trigger a virtual keyboard shift handler reset to enable the shift key */
	view.setFocus();
	view.activateWindow();
	//app.inputMethod()->update(Qt::InputMethodQueries(Qt::ImQueryInput));
