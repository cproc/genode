...
Genode::trace(this, ": ", __func__, ": check");
...
#if 1
if (_timeout_ms) {
Genode::trace(this, ": ", __PRETTY_FUNCTION__, ": ", _timeout_ms);
}
#endif
			_blockade.block();
#if 1
if (_timeout_ms) {
Genode::trace(this, ": ", __PRETTY_FUNCTION__, " finished");
}
#endif
		}
		...
		{
Genode::trace(this, ": ", __PRETTY_FUNCTION__);
			_woken_up = true;
			_blockade.wakeup();
		}
		...
		{
Genode::trace(this, ": ", __PRETTY_FUNCTION__, ", ret: ", __builtin_return_address(0));
			_expired = true;
			_blockade.wakeup();
		}
};
