                                ...
                                ::size_t count)
{
	...
	if (fd->flags & O_NONBLOCK) {
		monitor().monitor([&] {
Libc_trace_checkpoint trace_checkpoint("Vfs_plugin::write() nb", fd->fd_path);
		...
		monitor().monitor([&]
		{
Libc_trace_checkpoint trace_checkpoint("Vfs_plugin::write()", fd->fd_path);
                               ...
                               ::size_t count)
{
	...
	monitor().monitor([&] {
//Libc_trace_checkpoint trace_checkpoint("Vfs_plugin::read()", fd->fd_path);
