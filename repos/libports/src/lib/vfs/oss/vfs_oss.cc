...
//Genode::log("vfs_oss: write(): buf_size: ", buf_size, ", ofrag_bytes: ", _info.ofrag_bytes, ", _write_sample_offset: ", _write_sample_offset);
}
...
#if 0
static int count = 0;
if ((src_sample != 0) || (count == 0)) {
	src_sample = 128;
	Genode::log("vfs_oss: ", count);
	count++;
}
#endif
