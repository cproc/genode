...
void Libc::Component::construct(Libc::Env &env)
{
	Libc::with_libc([&] {
		...
		QPluginLoader qnitpickerviewwidget_plugin_loader("/qt/plugins/qnitpickerviewwidget/libqnitpickerviewwidget.lib.so");
		qnitpickerviewwidget_plugin_loader.setLoadHints(QLibrary::ExportExternalSymbolsHint);
		qnitpickerviewwidget_plugin_loader.load();
		...
		qDebug() << "plugin_widget_interface: " << plugin_widget_interface;
		QPluginWidget *plugin_widget = plugin_widget_interface->createWidget(&w, QUrl("rom:///test-plugin.tar"),
		                            plugin_args, 100, 100);
		qDebug() << "plugin_widget: " << plugin_widget;
