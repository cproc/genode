...
struct Core::Platform_pd_interface : Genode::Interface
{
	...
	virtual Session_label label() const = 0;
...
: public Address_space, public Platform_pd_interface, private Cap_space
{
	private:
		...
		Phys_allocated<Page_table_array> _table_alloc;
	...
	public:
		...
		Constructed const constructed =
			_table.constructed.ok() ? _table_alloc.constructed
			                        : _table.constructed;
		...
		Session_label label() const override { return _label; }
...
class Core::Core_platform_pd : public Platform_pd_interface, private Cap_space
{
	...
	public:
		...
		Session_label label() const override { return { "core" }; }
