...
class Vbox_pointer::Main : public Rom::Reader
{
	...
	public:
		...
		void notify_module_changed() override
		{
			...
			Genode::log("notify_module_changed(): hovered_label: ", _hovered_label);
			Genode::log("notify_module_changed(): hovered_domain: ", _hovered_domain);
			_update_pointer();
		}
...
void Vbox_pointer::Main::_update_pointer()
{
	...
	try {
		...
		Rom::Readable_module &shape_module =
			_rom_registry.lookup(*this, "calculatorform -> shape"); // XXX: _hovered_label

		Genode::log("_update_pointer(): found shape");
...
void Vbox_pointer::Main::_handle_hover()
{
	...
	try {
		...
		Genode::log("_handle_hover(): hovered_label: ", hovered_label);
		Genode::log("_handle_hover(): hovered_domain: ", hovered_domain);
