                               ...
                               public Init::Routed_service::Pd_accessor
{
	...
	public:
		...
		void announce_service(Service::Name const &service_name) override
		{
			...
			new (_alloc)
				Init::Routed_service(_child_services,
				                     "target",
				                     *this,
				                     *this,
			...
			// XXX: regenerate configuration
			_server.apply_config(Xml_node("<config> <service name=\"Nitpicker\"> <default-policy> <child name=\"target\"/> </default-policy> </service> </config>"));
