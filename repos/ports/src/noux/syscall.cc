...
Genode::log("PID ", pid(), ": SYSCALL_PIPE: ", _sysio.pipe_out.fd[0], "/", _sysio.pipe_out.fd[1]);
		...
		case SYSCALL_MKDIR:
		{
			...
			case Opendir_result::OPENDIR_OK:
				...
				_sysio.error.mkdir = Mkdir_result::MKDIR_OK;
				break;
			case Opendir_result::OPENDIR_ERR_LOOKUP_FAILED:
				_sysio.error.mkdir = Mkdir_result::MKDIR_ERR_NO_ENTRY;
				break;
			case Opendir_result::OPENDIR_ERR_NAME_TOO_LONG:
				_sysio.error.mkdir = Mkdir_result::MKDIR_ERR_NAME_TOO_LONG;
				break;
			case Opendir_result::OPENDIR_ERR_NODE_ALREADY_EXISTS:
				_sysio.error.mkdir = Mkdir_result::MKDIR_ERR_EXISTS;
				break;
			case Opendir_result::OPENDIR_ERR_NO_SPACE:
				_sysio.error.mkdir = Mkdir_result::MKDIR_ERR_NO_SPACE;
				break;
			case Opendir_result::OPENDIR_ERR_PERMISSION_DENIED:
				_sysio.error.mkdir = Mkdir_result::MKDIR_ERR_NO_PERM;
				break;
			}

			result = (_sysio.error.mkdir == Mkdir_result::MKDIR_OK);
			break;
		}
		...
		case SYSCALL_SYMLINK:
		{
			...
			typedef Vfs::Directory_service::Symlink_result  Symlink_result;
			...
			case Openlink_result::OPENLINK_OK:
				_sysio.error.symlink = Symlink_result::SYMLINK_OK;
				break;
			case Openlink_result::OPENLINK_ERR_LOOKUP_FAILED:
				_sysio.error.symlink = Symlink_result::SYMLINK_ERR_NO_ENTRY;
				break;
			case Openlink_result::OPENLINK_ERR_PERMISSION_DENIED:
				_sysio.error.symlink = Symlink_result::SYMLINK_ERR_NO_PERM;
			}
			...
			result = (_sysio.error.symlink == Symlink_result::SYMLINK_OK);
			break;
		}
