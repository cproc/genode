...
PGMMODE PGMGetGuestMode(PVMCPU) NOT_IMPLEMENTED_CHECKED(PGMMODE_INVALID)
int PGMChangeMode(PVMCPU, uint64_t, uint64_t, uint64_t) NOT_IMPLEMENTED_CHECKED(VINF_SUCCESS)
