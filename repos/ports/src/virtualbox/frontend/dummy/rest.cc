...
template<>
void DummyClass<Console>::fireStateChangedEvent(IEventSource*, MachineState_T)  TRACE()
template<>
void DummyClass<Console>::fireRuntimeErrorEvent(IEventSource*, BOOL aFatal,
                                                CBSTR aErrorID, CBSTR aMessage)
{
...
template<>
void DummyClass<Machine>::fireHostPCIDevicePlugEvent(IEventSource*, CBSTR,
                                                     BOOL, BOOL,
