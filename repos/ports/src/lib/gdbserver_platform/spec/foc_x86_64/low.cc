...
static bool in_syscall(Thread_state const &ts)
{
	 ...
	 * EIP:    5d     pop %ebp
	 */
	if ((genode_read_memory_byte((void*)(ts.ip)) == 0x5d) &&
		(genode_read_memory_byte((void*)(ts.ip - 5)) == 0x93) &&
		(genode_read_memory_byte((void*)(ts.ip - 6)) == 0xff) &&
		(genode_read_memory_byte((void*)(ts.ip - 7)) == 0x55))
		return true;
...
extern "C" int genode_fetch_register(int regno, unsigned long *value)
{
	...
	if (in_syscall(ts) || ts.unresolved_page_fault) {
		...
		{
			case RAX:    cannot_fetch_register("RAX");   return -1;
			case RBX:    cannot_fetch_register("RBX");   return -1;
			case RCX:    cannot_fetch_register("RCX");   return -1;
			case RDX:    cannot_fetch_register("RDX");   return -1;
			case RSI:    cannot_fetch_register("RSI");   return -1;
			case RDI:    cannot_fetch_register("RDI");   return -1;
...
#endif
					cannot_fetch_register("RBP"); return -1;
#if 0
				}
#endif
			...
			case R11:    cannot_fetch_register("R11");   return -1;
			case R12:    cannot_fetch_register("R12");   return -1;
			case R13:    cannot_fetch_register("R13");   return -1;
			case R14:    cannot_fetch_register("R14");   return -1;
			case R15:    cannot_fetch_register("R15");   return -1;
			case RIP:    fetch_register("RIP", ts.ip, *value); return 0;
			case EFLAGS: cannot_fetch_register("RFL");   return -1;
