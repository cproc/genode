...
{
	{
		Mutex::Guard guard(_mutex, "Registry_base::Element", "Registry_base::Element::~Element()");
...
{
	Mutex::Guard guard(_mutex, "Registry_base", "Registry_base::_insert()");
...
{
	Mutex::Guard guard(_mutex, "Registry_base", "Registry_base::_remove()");
                                                  ...
                                                  Element &e, Element *at)
{
	...
	Mutex::Guard guard(e._mutex, "Registry_base", "Registry_base::_processed()");
...
{
	Mutex::Guard guard(_mutex, "Registry_base", "Registry_base::_for_each()");
	...
	while (Element *e = _elements.first()) {
		...
		Notify notify(Notify::Keep::KEEP, Thread::myself());
		{
			...
			Mutex::Guard guard(e->_mutex, "Registry_base", "Registry_base::_for_each()");
			_curr = e;
