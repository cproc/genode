...
{
Genode::log("platform_driver_register(): ", drv);
...
Genode::log(__func__, ": calling ndo_open(): ", dev);
...
{
Genode::log("device_add(): dev: ", dev, ", ret: ", __builtin_return_address(0));
	if (dev->driver)
		return 0;
...
{
	Genode::log(__func__, ": dev: ", dev, ", ret: ", __builtin_return_address(0));
