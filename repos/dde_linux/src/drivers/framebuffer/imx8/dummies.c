...
void chained_irq_enter(struct irq_chip *chip,
                       struct irq_desc *desc)
{
	TRACE_AND_STOP;
}

void chained_irq_exit(struct irq_chip *chip,
                      struct irq_desc *desc)
{
	TRACE_AND_STOP;
}
...
struct irq_chip *irq_desc_get_chip(struct irq_desc *desc)
{
	TRACE_AND_STOP;
	return NULL;
}

void *irq_desc_get_handler_data(struct irq_desc *desc)
{
	TRACE_AND_STOP;
	return NULL;
}
