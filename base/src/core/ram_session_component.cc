...
{
	Object_guard<Dataspace_component> dsc(_ds_ep->lookup_and_lock(ds));
...
int Ram_session_component::ref_account(Ram_session_capability ram_session_cap)
{
	...
	Object_guard<Ram_session_component> ref(_ram_session_ep->lookup_and_lock(ram_session_cap));
                                          ...
                                          size_t amount)
{
	...
	Object_guard<Ram_session_component> dst(_ram_session_ep->lookup_and_lock(ram_session_cap));
