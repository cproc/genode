...
class Decorator::Window : public Window_base
{
	...
	public:
		...
		void update(Xml_node window_node) override;
};
...
void Decorator::Window::update(Genode::Xml_node window_node)
{
	Window_base::update(window_node);
	...
	_title = Decorator::string_attribute(window_node, "title", Title("<untitled>"));
}
