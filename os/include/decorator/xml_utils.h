...
Decorator::attribute(Xml_node const &node, char const *name, T default_value)
{
	...
	if (node.has_attribute(name))
		...
		PWRN("nonexistent attribute %s", name);
 ...
 */
static Decorator::Point Decorator::point_attribute(Genode::Xml_node const &point)
{
 ...
 */
static Decorator::Area Decorator::area_attribute(Genode::Xml_node const &area)
{
 ...
 */
static Decorator::Rect Decorator::rect_attribute(Genode::Xml_node const &rect)
{
